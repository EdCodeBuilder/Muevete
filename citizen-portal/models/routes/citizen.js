...
export default {
  ...
  CITIZEN_ACTIVITIES: () => `${api}/${prefix}/activities`, // 21-07-2022 cambio de ruta /activities a /activity-asisstances
  CITIZEN_ACTIVITY_ASSISTANCES: () => `${api}/${prefix}/activity-asisstances`,
