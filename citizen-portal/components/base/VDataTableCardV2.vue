  ...
  <v-container id="dashboard" fluid tag="section">
    ...
    >
      <v-card>
        ...
        <v-card-text class="d-flex justify-center">
          <div>Fecha - Hora inicio - Hora Fin</div>
        </v-card-text>
        <v-card-text class="d-flex justify-center">
          <div>Registro de asistencia</div>
        </v-card-text>
        <div class="ms-4">
          <v-text-field label="Digite su número de documento"></v-text-field>
        </div>
        <div class="ms-4">
          <v-text-field label="Confirme su número de documento"></v-text-field>
        </div>
        <v-card-actions class="d-flex justify-center">
          <div>
            <v-btn color="primary">Registrar usuario</v-btn>
          </div>
        </v-card-actions>
      </v-card>
